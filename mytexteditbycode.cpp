...
void MyTextEditByCode::initConnection()
{
    ...
    connect(textEdit->verticalScrollBar(),SIGNAL(valueChanged(int)),this,SLOT(onTextEditVerticaltalScrollBarChanged()));
...
void MyTextEditByCode::onTextEditVerticaltalScrollBarChanged(){
